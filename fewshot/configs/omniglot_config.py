...
class BasicConfig(object):
    ...
    def __init__(self):
        ...
        self.lr_decay_steps = [4000, 6000, 8000, 10000, 12000,
                               14000, 16000, 18000, 20000]  # 6000, 8000, 4000,
...
class KMeansRefineConfig(BasicConfig):
    ...
    def __init__(self):
        ...
        self.name = "omniglot-kmeans-refine-learn-sigmal-" + \
            str(self.learn_sigma_l)
...
class KMeansDistractorConfig(BasicConfig):
    ...
    def __init__(self):
        ...
        self.name = "omniglot-"+self.model_class+"-learn-sigmau-" + \
            str(self.learn_sigma_u) + "-learn-sigmal-" + str(self.learn_sigma_l)
